...
const AddReading = () => {
  ...
  //     ? myBookReadingFinish({ bookId, endPage: page })
  //     : myBookReadingStart({ bookId, startPage: page });
  ...
  const onSubmit = ({ page }) => {
    if (isReadingNow) {
      dispatch(myBookReadingFinish({ bookId, endPage: page }));
    } else {
      dispatch(myBookReadingStart({ bookId, startPage: page }));
    }
  };
