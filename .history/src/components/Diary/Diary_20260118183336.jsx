...
import { formatDate, calcMinutes } from '../../utils/readingUtils.js';
        ...
        {progress.map(item => (
          <li key={item._id} className={css.item}>
            <div className={css.row}>
              ...
              <span className={css.pagesEnd}>{item.endPages} pages</span>
            </div>
            <div className={css.row}>
              <span className={css.percentRead}>{item.percent}%</span>
              <span className={css.time}>
                {calcMinutes(item.startReading, item.finishReading)} min
              </span>
            </div>
            <div className={css.row}>
