  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="4"
        d="M16 16l-5.697-4.748c-0.846-0.705-1.27-1.058-1.574-1.49-0.27-0.383-0.47-0.811-0.591-1.263-0.137-0.511-0.137-1.061-0.137-2.163v-3.669M16 16l5.697-4.748c0.846-0.705 1.27-1.058 1.574-1.49 0.27-0.383 0.47-0.811 0.591-1.263 0.137-0.511 0.137-1.061 0.137-2.163v-3.669M16 16l-5.697 4.748c-0.846 0.705-1.27 1.058-1.574 1.49-0.27 0.383-0.47 0.811-0.591 1.263-0.137 0.51-0.137 1.061-0.137 2.163v3.669M16 16l5.697 4.748c0.846 0.705 1.27 1.058 1.574 1.49 0.27 0.383 0.47 0.811 0.591 1.263 0.137 0.51 0.137 1.061 0.137 2.163v3.669"
      ></path>
      <path
        strokeLinejoin="round"
        strokeLinecap="round"
        strokeMiterlimit="4"
        strokeWidth="4"
        d="M5.334 2.667h21.333M5.334 29.333h21.333"
      ></path>
    </svg>
  );
};

export const RectangleNotActiveIcon = () => {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      <path
        fill="#686868"
        d="M8 0h16c4.418 0 8 3.582 8 8v16c0 4.418-3.582 8-8 8h-16c-4.418 0-8-3.582-8-8v-16c0-4.418 3.582-8 8-8z"
      ></path>
      <path
        fill="#1f1f1f"
        d="M12 8h8c2.209 0 4 1.791 4 4v8c0 2.209-1.791 4-4 4h-8c-2.209 0-4-1.791-4-4v-8c0-2.209 1.791-4 4-4z"
      ></path>
    </svg>
  );
};

export const RectangleActiveIcon = () => {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      <path
        fill="#f9f9f9"
        style="fill: var(--color3, #f9f9f9)"
        d="M8 0h16c4.418 0 8 3.582 8 8v16c0 4.418-3.582 8-8 8h-16c-4.418 0-8-3.582-8-8v-16c0-4.418 3.582-8 8-8z"
      ></path>
      <path
        fill="#141414"
        style="fill: var(--color4, #141414)"
        d="M12 8h8c2.209 0 4 1.791 4 4v8c0 2.209-1.791 4-4 4h-8c-2.209 0-4-1.791-4-4v-8c0-2.209 1.791-4 4-4z"
      ></path>
    </svg>
  );
...
<symbol id="icon-rectangleActive" viewBox="0 0 32 32"></symbol>;
