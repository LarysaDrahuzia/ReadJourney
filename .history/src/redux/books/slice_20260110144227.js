  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(myBookReadingStart.fulfilled, (state, action) => {
        ...
        state.reading.isReading = true;
        state.reading.session = action.payload;
      })
      ...
      .addCase(myBookReadingFinish.fulfilled, (state, action) => {
        state.reading.isLoading = false;
        state.reading.isReading = false;
        state.reading.session = action.payload.session;
        state.reading.diary = action.payload.diary ?? [];
        state.reading.statistics = action.payload.statistics;
      })
