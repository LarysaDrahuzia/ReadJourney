...
export const selectReadingBook = state => state.books.reading;
export const selectIsReadingBook = state => state.books.reading.isReading;
export const selectReadingDiary = state => state.books.reading.diary;
export const selectReadingStatistics = state => state.books.reading.statistics;
export const selectReadingSession = state => state.books.reading.session;
